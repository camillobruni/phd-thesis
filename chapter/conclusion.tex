...
\begin{description}
	\item[Collaboration on First-class Layouts and Slots:]
		...
		In Collaboration with Martin Días (\RMoD, \INRIA) this initial version was ported to \PH\footnote{\url{}}and is now used in the current release candidate \PH 3.0\footnote{\url{http://files.pharo.org/image/30}}.
