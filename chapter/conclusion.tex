...
\todo{Address the problem statements from the introduction/background}\\
\todo{summary chapter 2: background}\\
\todo{summary chapter 3: language-side reification / inspectors}\\
\todo{summary chapter 4: benzo}\\
\todo{summary chapter 5: benzo ffi}\\
\todo{summary chapter 6: benzo validation}\\
\todo{summary chapter 7: future work}\\
