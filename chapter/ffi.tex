...
As shown in the examples in \secref{ffi-nutshell} and in more detail in \figref{nativeBoostSyntax} \NB detects which method arguments correspond to which argument in the \FFI callout.
...
The examples in \secref{ffi-nutshell}, especially \figref{nativeBoostSyntax} show that each \NBFFI callout requires a special primitive.
