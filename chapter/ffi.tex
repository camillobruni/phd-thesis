...
\sm{I find those choices all questionable, why don't you call stuff under your control? A little C library, compiled with no, or predictable optimization, of which you actually know the execution cost?}
%
\begin{table}[h!]
    \centering
    \begin{tabular}{rSS}
