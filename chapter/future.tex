...
\todo{refer to \secref{background-reified-vms}} \\
\todo{Lessons learned not only from \B} \\
\todo{inspirations from other projects}

% -----------------------------------------------------------------------------
\subsection{\P \VM}
% -----------------------------------------------------------------------------
\todo{refer to \secref{background-pinocchio}} \\
