...
To explain that we have a look at the frame setup of a jitted method in \Cog shown in \lstref{val-nabujito-cog-frame}.
%
\begin{numstcode}[
...
\end{numstcode} 
%
After finishing this setup instructions the stack frame looks as depicted in \figref{val-nabujito-cog-stackframe}.
%
\begin{figure}[h]
	\centering
	\includegraphics[scale=1.1]{cog-stackframe}
	\caption{\Cog Stackframe Header}
	\figlabel{val-nabujito-cog-stackframe}
\end{figure}
