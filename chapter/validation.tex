...
\end{numstcode} 
%
After finishing this setup instructions the stack frame looks as depicted in \figref{val-nabujito-cog-stack-frame}.
%
\begin{figure}[h]
	\centering
	\includegraphics[scale=1.1]{cog-stack-frame}
