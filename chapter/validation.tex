...
\begin{enumerate}[noitemsep,nolistsep]
	...
	\item The second is to run the language-side implementation that is triggered whenever the standard primitive failed.
	\item Finally the fast standard primitive provided by the \VM.
\end{enumerate}
%
