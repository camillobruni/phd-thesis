...
\begin{figure}
	...
	\caption{\WF Compiler Steps}
	\figlabel{waterfall-architecture}
\end{figure}

\todo{this goes already too much into detail with \WF more to the architecture section}
...
The \WF compiler consists of the following elements:
%
