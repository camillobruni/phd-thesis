...
As shown in \figref{waterfall-architecture} the \WF compiler transform the \AST of the \Slang input to \PH primitives.
...
\begin{description}
\item[\Slang to \AST:] The first step is to access the \AST of the \Slang sources which happens automatically by loading the \Slang code in the \PH image.	
...
\noindent With these compilation steps we are capable of compiling 
