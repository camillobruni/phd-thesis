...
We see that the instrumentation overhead compared to the non-instrument \WF is in the range of only $0.7$ms whereas in the \PH version the overhead is several magnitudes higher.
