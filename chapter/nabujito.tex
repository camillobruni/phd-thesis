...
\todo{Introduction explaining why a different chapter for Nabujito + \WF}
...
\seclabel{nabujito-background}
% ---------------------------------------------------------------------------
In this section we present Nabujito, a \B-based approach for a language-side JIT compiler.
Nabujito goes even further than \WF using almost the same techniques.
...
In \secref{waterfall} we describe how \WF suffers a similar constraint.
...
\seclabel{nabujito-implementation}
%----------------------------------------------------------------------------
...
From the in-production experience of \NB, the \B-based FFI (see \secref{nb-performance}), we know that these costs amortized, especially for long-term applications.
...
\begin{table}[!ht]
    ...
    \end{tabular}
    \caption[\Nabujito Compilation Speed]{Compilation efforts of the standard \ST compiler in \PH and \Nabujito for the a simple method returning the constant \ttt{nil}.}
...
\WF uses \B's mechanism for replacing primitive methods with customized versions that are nativized dynamically as described in \secref{benzo}.
...
In section \secref{wf-performance} we show how \WF, the \B based approach for generating primitives on the fly, outperforms the reflective solutions for primitives instrumentation. 


% -----------------------------------------------------------------------------
\subsection{Implementation}
\seclabel{waterfall-implementation}
% -----------------------------------------------------------------------------
...
% -----------------------------------------------------------------------------
\subsection{Validation}
\seclabel{waterfall-performance}
% -----------------------------------------------------------------------------
...
We present the results of this experiment in ~\tabref{waterfall-performance}.
%
\begin{table}[!ht]
    \centering
    \begin{tabular}{rrr}
