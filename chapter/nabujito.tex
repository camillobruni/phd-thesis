...
\todo{Introduction explaining why a different chapter for Nabujito + Waterfall}
...
% -----------------------------------------------------------------------------
\todo{Copy Over Waterfall Explanation from the Paper}
...
\begin{table*}[t]
    ...
    \end{tabular}
    \caption{Slowdown comparison for instrumentation of the  essential primitive \ttt{basicNew}.}
