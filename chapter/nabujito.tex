...
In \tabref{nabujito-performance-small} we compare the compilation speed of the standard \PH compiler and \NBJ.
...
We see that in the simple case displayed in \tabref{nabujito-performance-small} \NBJ's compilation speed lies within the same range as the standard \ST compiler.
