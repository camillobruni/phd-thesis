...
\begin{figure}[ht]
    \centering
    \includegraphics{nativeCodeMethodDetail}
...
\begin{figure}[ht]
	\centering
	\includegraphics{nabujitoInline}
...
The second \B-based application we present takes the concept of our \FFI solution further.
...
\begin{figure}[h]
	...
	\caption[Language Extension Mechanisms]{\todo{Use 2x2 Subfigure}Comparing different extension mechanisms: 
...
Several languages such as \ST, Python, \urlfootnote{Ruby}{http://www.ruby-lang.org/}, and others provide reflective capabilities with different depths \cite{Ande98a,Van10a}.
