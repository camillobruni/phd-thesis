...
%----------------------------------------------------------------------------
\subsection{\VM Extensions and Forks.}
...
However, plugins are commonly written in the same language as the \VM, at a low abstraction level, which means that they can no longer be changed easily at runtime.
Few exceptions are self-hosted languages \cite{Unga05a,Wimm13a,Rigo06a}.
\todo{weird connection}
...
Instead they tend to be very complex and to have sluggish building processes.
...
For instance, \todo{back in time debugger} \cite{Lien08b}.

\paragraph{\VM Generation Framworks}
\todo{properly integrate: make link from unmaintable fork to use a well-defined interface at that level}
...
\todo{summary + connection paragraph}
...
\todo{\B related (more suitable in the following situations):}

\todo{\B outlook: future and following chapterse}
