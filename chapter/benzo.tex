...
\begin{figure}[ht]
	...
	\caption{\todo{Add Primitive Failure Link}Native code activation with \B: The first call triggers the code generation. Then the method is restarted and the native code executed.}
