...
\begin{table}[!ht]
    ...
    \end{tabular}
    \caption[Basic \B-based JIT Performance]{Compilation efforts of the standard \ST compiler in \PH and Nabujito for the a simple method returning the constant \ttt{nil}.}
