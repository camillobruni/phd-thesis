...
In \PH it is possible to willingly corrupt the stack by for instance injecting a wrong sender as illustrated with following the code example.
%
...
Implementing a second version of the \B plugin to activate native code would solve this issue, though at the cost of an additional primitive.
