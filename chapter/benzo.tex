...
In \secref{usecase} we advocate the contribution of this approach by providing three different incremental examples that heavily use the framework.
...
The three usecase presented in \secref{usecase} heavily benefit from this fact.
