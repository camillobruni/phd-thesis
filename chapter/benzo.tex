...
\noindent In \tabref{benzo-nabujito-performance-small} we compare the compilation speed of the standard \PH compiler and \NBJ.
...
A subsequent restart of the same runtime will not cause the \JIT to compile the same methods it did during the last launch.
Hence our approach is even valid for short-lived applications as most of the methods will already be available in optimized native code from a previous run.
