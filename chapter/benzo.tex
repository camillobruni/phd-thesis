...
Typically, even very complex \VMs have a clean interface to build plugins.
...
For instance, \todo{ref to back in time}.
...
\todo{\B outlook: future and following chapters}
