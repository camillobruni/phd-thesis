...
% ---------------------------------------------------------------------------
\todo{Image: Infrastructure Overview}\\
\todo{absorbs a lot of properties, fairly mature}
...
%PyPy stands out as it is a complete VM creation toolchain that compiles an abstract description of a bytecode interpreter.
%With proper hints in the interpreter sources, PyPy is able to generate a specific JIT.
