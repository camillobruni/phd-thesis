...
\noindent Unless specified otherwise we refer by \emph{reflection} or \emph{dynamic reflection} to unanticipated behavioral \emph{and} structural reflection both for performing intercession and introspection.
In figures we use a circular arrow (\includegraphics[height=10pt]{reflection-arrow-black}) to symbolize reflection.
...
\begin{figure}[h]
	...
	\caption[High-level Language Reflection Evolution]{
		Evolution of reflection in high-level language runtimes.
