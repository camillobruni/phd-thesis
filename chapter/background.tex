...
\item[Invocation Chain:] A second interesting limitation axis is the stack.
...
And in dynamic system \ugh{like \PH} \sm{Like Pharo? I always dislike that kind of stuff in papers from Lille, come on, there are plenty of systems that have those needs. Singling out on, is bad style in my perspective } it has to be made aware of language-side changes to properly update the generated native code.
...
For highly reflective and dynamic languages \ugh{like \PH} we see a certain mismatch.
...
\ugh{One of the first metacircular} \VMs presented is the \Squeak \VM\cite{Inga97a}.
