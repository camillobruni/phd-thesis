...
\todo{Do we mention Dwarf Python? using dwarf debugging information to reify the low-level part of the \VM}
...
% ===========================================================================
\todo{intercession => reflection}
Intercession is typically only applied at language-side to reflectively alter behavior or structure.
In the case of the classical separation of the \VM from the language-side, this functionality stays isolated at language-side.

However, this is different in a self-aware \VM or language-runtime supporting a reflective language.
...
% ===========================================================================
\cb{I sort of feel that this is almost the same as problem 2, maybe this here is more explicit in what we want to try?}
