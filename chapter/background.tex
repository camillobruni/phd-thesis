...
\noindent These four categories summarize the properties of reflection and unless specified otherwise we refer by \emph{reflection} or \emph{dynamic reflection} to unanticipated behavioral \emph{and} structural reflection both for performing intercession and introspection.
From now on we use a circular arrow (\includegraphics[height=10pt]{reflection-arrow-black}) to symbolize reflection in a figure.
