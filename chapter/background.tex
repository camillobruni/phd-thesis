...
% ---------------------------------------------------------------------------
\urlfootnote{\PyPy}{http://pypy.org/} is a \Python-based high-level \VM framework.
\PyPy's major focus lies on an efficient metacircular \Python interpreter.
However, it has been successfully used to build \VMs for other languages including \ST.
...
For instance in the previously presented Squeak\cite{Inga97a} and also the \Jikes \VM framework the final \VM implementation is not much different from C or C++.
...
The \JIT is handled in a similar way.
