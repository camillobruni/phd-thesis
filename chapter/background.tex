...
\todo{recap initial statement of incidental reflective locjout}
\todo{we further focus on metacircular VMs, close match with the reflective approach, or close metacircular VMs}
...
However, for certain applications such as interaction with external native libraries this proves to be a limitation \cite{Kell11a}.
