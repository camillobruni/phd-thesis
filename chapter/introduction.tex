...
\todo{Background:}\\
\todo{intro to reflection}

\todo{Intro to vm}\\
\todo{- separation from hardware}

\todo{intro to seprattion of reflection}\\
\todo{- incidental due to choice of implemetnation language}\\
\todo{- original HW separation in mind, doesn't promote dynamic changes}
