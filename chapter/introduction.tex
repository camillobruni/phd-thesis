...
% =============================================================================
\sm{Artefacts are note the contributions of a thesis, they might be 'technical contributions'.

Contributions are ideas/designs in combination with what you learned about them in the evaluation}

% =============================================================================
\section{Artifacts}
% =============================================================================

\todo{rewrite intro paragraph}
...
\begin{description}
	...
	\sm{None of these talks about reflection.
	
	I think, I am expecting something very different than what you want to sell, you got me in the wrong direction.
	
	Again, I would try to make it more explicit that the high level low level programming is what you are interested in evaluating. Reflection is only the bigger picture motivation}
