...
\begin{description}
	...
	\todo{in collaboration with Igor stasenko}
...
\gt{By allowing an application to access and to modify the internal structures of the virtual machine, the isolation property is lost. It could be interesting to discuss this point in the introduction.}
