...
However, there are \VMs that are implemented using high-level languages which support reflection themselves.
...
\todo{Sate of the art:}\\
\todo{- new vms and vm building processes overcome this limitations}\\
\todo{- high-level low-level programming}\\
\todo{- metacircular vms match well..}\\
\todo{- klein and Co}\\
\todo{- diffferent levels...}

\todo{Problem / Plant:}\\
\todo{- overcome separation of refelction}\\
\todo{- minimal approach using minimal interface}\\
\todo{- incremental approach runing on top of an existing solution}\\
\todo{- what is the tradeoff of using a simpler approach?}
