...
Recently several language-runtimes appeared that no longer make this strong separation \cite{Klein, Pino}.
...
This allows us to modify and inspect the \VM.
The \VM is reflective.
