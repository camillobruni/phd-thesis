...
\begin{description}
	...
	\item[XXX]
	\todo{make reflection problem less specific}
	\todo{No dynamic high-levle low-level programming framework}
...
% =============================================================================
\todo{maybe one paragraph: lowerinf from the high-level problem to the real solution / engineering implementation}
