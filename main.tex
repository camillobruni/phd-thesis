...
We show how \B is used to build an efficient \FFI interface, allowing for a more structured access to \VM internal functions.

To evaluate the boundaries of our approach we target two more applications: dynamic primitives and a language-side \JIT compiler.
