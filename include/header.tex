...
\usepackage[left=1.7cm,right=1.7cm,top=1cm,bottom=1cm,includefoot,includehead,headheight=13.6pt]{geometry}
...
\usepackage{lettrine} % multiline first letters
